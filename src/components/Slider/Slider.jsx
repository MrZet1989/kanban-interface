        ...
        <Slider {...settings}>
          ...
          <div>
            <div className={style.slidersBlock}>
              <img className={style.imageBlock}
                   src='https://itbukva.com/images/articles/111/Depositphotos_94367998_l-2015.jpg' alt='pic'/>
              ...
              <div className={style.sliderTextBlock}>
                <div>
                  ...
                  <div className={style.sliderText}>Incididunt cillum do sint sint enim ullamco id deserunt mollit qui
                    ...
                    sint non. Occaecat aute officia excepteur non laboris id qui ad.
                  </div>
                </div>
              </div>
            </div>
          ...
          <div>
            <div className={style.slidersBlock}>
              <img className={style.imageBlock}
                   src='https://bgstaff.ru/upload/bgstaff/pages/Professiya_web_razrabotchik_bystryj_poisk_sotrudnikov.png'
                   alt='pic'/>
              <div className={style.imgInfo}>
                <h2 className={style.sliderH2}>Ronaldo Richards</h2>
                <h3 className={style.sliderH3}>Product Manager</h3>
