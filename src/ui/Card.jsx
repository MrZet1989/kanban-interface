        ...
        {dat.map((item) => <div key={item.id} className={style.cardItem}>
          ...
          <div className={style.cardBottomBlock}>
            <div className={style.cardBottomBlockIcon}>
              {item.state ? <AiFillHeart onClick={() => handleHeart(item.id)} className={style.cardHeartIconRed}/> :
                <AiFillHeart onClick={() => handleHeart(item.id)} className={style.cardHeartIcon}/>}
